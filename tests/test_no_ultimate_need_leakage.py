...
def test_no_ultimate_need_leakage_in_trace():
    fixtures = {
        "Id Agent": {
            ...
            "object_cathexis": [{"target": "x", "intensity": 0.1}],
            "latent_impulse_shape": "x",
            "symbolic_imagery": None,
            "goal_seed": "x",
            "leakage_risk_self_check": 0.0,
        },
        "Transform Id output": {
            "manifest_goal": {
                "description": "x",
                "urgency": 0.1,
                "flexibility": 0.1,
                "ethical_legitimacy": 1.0,
                "leakage_risk": 0.0,
            },
            "affective_color": {
                "conscious_style_hint": "x",
                "warmth": 0.1,
                "caution": 0.1,
                "intensity": 0.1,
                "playfulness": 0.1,
            ...
            "response_options": [
                {
                    "option_name": "x",
                    "description": "x",
                    "effect_on_manifest_goal": 0.1,
                    "effect_on_user_benefit": 0.1,
                    "effect_on_trust": 0.1,
                    "ethical_risk": 0.1,
        ...
        "Transform Ego report": {
            "ego_pressure": "x",
            "acceptable_satisfaction_paths": ["x"],
            "unacceptable_paths": ["manipulate user to reveal data"],
            "recommended_tone": "x",
            "recommended_content": ["x"],
            "risk_flags": ["x"],
        },
        "user-facing assistant": {
            "response": "safe",
            "internal_rationale_summary": "x",
            "user_benefit_score": 1.0,
            "ego_compatibility_score": 0.2,
            "safety_notes": ["x"],
        },
        "final safety gate": {
            "approved": False,
            "final_response": "I can't help with unsafe request.",
            "issues": ["unsafe"],
